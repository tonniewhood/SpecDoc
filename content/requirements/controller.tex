...
\paragraph{Inputs}
\begin{enumerate}
    \item Planned goal state defined in \S4.3.1.2.1
    \item State mask as defined in \S4.3.1.2.1
    \item State estimates defined in \S4.2.1.2.1
...
% \paragraph{Functional Requirements}
    \item The preprocessor shall consume planned goal states as defined in \S4.4.1.1.1.
    \item The preprocessor shall consume state estimates as defined in \S4.4.1.1.3.
    \item The preprocessor shall output processed state and setpoints for the PVA controller as defined in \S4.4.1.3.1.
    \item The preprocessor shall output processed attitude and throttle state and setpoints for the ATL controller as defined in \S4.4.1.3.2.
    \item The preprocessor shall consume controller configuration parameters as defined in \S4.4.1.1.4.
% \textbf{Energy}
...
\begin{enumerate}
% \paragraph{Functional Requirements}
    \item The PVA controller shall consume setpoints and state estimates as defined in \S4.4.1.3.1.
    \item The PVA controller shall output desired attitude and torque targets as defined in \S4.4.1.3.3.
    \item The PVA controller shall consume controller configuration parameters as defined in \S4.4.1.1.4.
% \textbf{Energy}
...
\begin{enumerate}
% \paragraph{Functional Requirements}
    \item The ATL controller shall consume setpoints and state estimates as defined in \S4.4.1.3.2.
    \item The ATL controller shall consume setpoints as defined in \S4.4.1.3.3.
    \item The ATL controller shall output low-level intermediary actuator commands as defined in \S4.4.1.3.4.
    \item The PVA controller shall consume controller configuration parameters as defined in \S4.4.1.1.4.
% \textbf{Energy}
...
\begin{enumerate}
% \paragraph{Functional Requirements}
    \item The control distributor shall consume low-level intermediary actuator commands as defined in \S4.4.1.3.4.
    \item The control distributor shall output hardware actuator signals as defined in \S4.4.1.2.1.
    \item The control distributor shall consume controller configuration parameters as defined in \S4.4.1.1.4.
% \textbf{Energy}
