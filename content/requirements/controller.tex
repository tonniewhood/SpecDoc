...
% \textbf{Environments}
    \item The preprocessor shall function agnostic to the UAV environment.
...
% \textbf{Standards and Regulations}
    \item The preprocessor shall adhere to all coding standards defined under \S3.1.5.
\end{enumerate}
...
% \textbf{Standards and Regulations}
    \item The PVA controller shall adhere to all coding standards defined under \S3.1.5.
\end{enumerate}
...
% \textbf{Standards and Regulations}
    \item The ATL controller shall adhere to all coding standards defined under \S3.1.5.
\end{enumerate}
...
% \textbf{Environments}
    \item The control distributor shall function agnostic to the UAV environment.
...
% \textbf{Standards and Regulations}
    \item The control distributor shall adhere to all coding standards defined under \S3.1.5.
\end{enumerate}
