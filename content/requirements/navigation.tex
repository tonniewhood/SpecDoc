...
% \textbf{Standards and Regulations}
    \item The sensor selector shall adhere to all coding standards defined under \S3.1.1.7 and \S3.1.5.
\end{enumerate}
...
% \textbf{Standards and Regulations}
    \item The estimator shall adhere to all coding standards defined under \S3.1.1.7 and \S3.1.5.
\end{enumerate}
