...
\begin{enumerate}
    ...
    \item Logging data containing any combination of sensor selection, estimation events, and error reports
\end{enumerate}
\paragraph{Internal}
\begin{enumerate}
...
% \paragraph{Functional Requirements}
    \item The sensor selector unit shall consume all available sensor feeds defined in \S3.2.1.1.1.
    \item The sensor selector unit shall consume sensor selection configuration as defined in \S3.2.1.1.2.
    \item The sensor selector unit shall output selected sensor feeds for the estimator as defined in \S3.2.1.3.1.
% \textbf{Energy}
    \item The sensor selector shall not consume more than 5\% of the selected processing unit's bandwidth.
% \textbf{Environments}
    \item The sensor selector shall function agnostic to the UAV environment.
% \textbf{Safety}
...
% \textbf{Standards and Regulations}
    \item The sensor selector shall adhere to all coding standards defined under \S3.1.5.
\end{enumerate}
...
\begin{enumerate}
% \paragraph{Functional Requirements}
    \item The estimator shall provide state estimate outputs and uncertainties as defined in \S3.2.1.2.1.
    \item The estimator shall consume selected sensor streams defined in \S3.2.1.3.1.
    \item The estimator shall comsume navigation configuration parameters as defined in \S3.2.1.1.2.
...
% \textbf{Environments}
    ...
    \item The estimator shall use the configuration to be congnisant to sensor mounting orientations and translate them into a common frame.
% \textbf{Safety}
...
% \textbf{Standards and Regulations}
    \item The estimator shall adhere to all coding standards defined under \S3.1.5.
\end{enumerate}
