...
% \paragraph{Functional Requirements}
    \item The sensor selector unit shall consume all available sensor feeds defined in \S4.2.1.1.1.
    \item The sensor selector unit shall consume sensor selection configuration as defined in \S4.2.1.1.2.
    \item The sensor selector unit shall output selected sensor feeds for the estimator as defined in \S4.2.1.3.1.
% \textbf{Energy}
...
\begin{enumerate}
% \paragraph{Functional Requirements}
    \item The estimator shall provide state estimate outputs and uncertainties as defined in \S4.2.1.2.1.
    \item The estimator shall consume selected sensor streams defined in \S4.2.1.3.1.
    \item The estimator shall comsume navigation configuration parameters as defined in \S4.2.1.1.2.
