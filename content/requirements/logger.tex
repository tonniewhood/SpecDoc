...
\begin{enumerate}
    \item The Storage submodule shall have default storage location of '/logs/' on onboard non-volatile memory.
    \item The Storage submodule shall default to storing data from each data stream in a '.log' file with timestamps for each entry.
