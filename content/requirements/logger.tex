...
\begin{enumerate}
    ...
    \item Logs from the Navigation submodule as defined in \S4.2.1.2.2.
    \item Logs from the Planner submodule as defined in \S4.3.1.2.3.
    \item Logs from the Controller submodule as defined in \S4.4.1.2.2.
\end{enumerate}
\paragraph{Outputs}
\begin{enumerate}
    \item Log files
...
\begin{enumerate}
    ...
    \item The Logger shall support rate limiting for all logged data controled by a configuration parameter as defined in \S4.5.2.1.
    \item The Logger shall adhere to all coding standards defined under \S4.1.5.
...
\begin{enumerate}
    ...
    \item The Storage submodule shall support a sliding window in which to save log files based on either time duration or storage size limits determined by the Logger configuration parameters defined in \S4.5.2.1.
