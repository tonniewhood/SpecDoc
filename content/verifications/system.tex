...
\begin{enumerate}
    ...
    \item Requirement shall be verified by using static analysis tools such as linters and formatters to ensure compliance with the coding standards outlined in section \S4.1.2.7
\end{enumerate}
