...
\begin{enumerate}
    \item Requirement shall be verified by inspecting the FCM datasheet and the physical PCB to confirm that pins for the I$^2$C interface are exposed.
    \item Requirement shall be verified by inspecting the FCM datasheet and the physical PCB to confirm that pins for the SPI interface are exposed.
    \item Requirement shall be verified by inspecting the FCM datasheet and the physical PCB to confirm that pins for the UART interface are exposed.
    \item Requirement shall be verified by inspecting the FCM datasheet and the physical PCB to confirm that pins for the 2 conductor CAN bus interface are exposed.
    \item Requirement shall be verified by visual inspection of the FCM to confirm that a micro SD slot is present and connects to the SPI interface.
    \item Requirement shall be verified by visual inspection of the FCM to confirm that a USB A port is present and connects to the USB 2.0 interface.
    ...
    \item Requirement shall be verified by reviewing the FCM datasheet and with a loadcell measuring the connectors to confirm they adhere to the FAA L-823 3.3.3 Mechanical Connection specification.
\end{enumerate}
...
\begin{enumerate}
    \item Requirement shall be verified by measuring the cross-sectional area of the FCM using calipers and confirming it does not exceed $412.5$ cm$^2$.
    \item Requirement shall be verified by measuring the depth of the FCM using calipers and confirming it does not exceed $7.5$ cm.
    \item Requirement shall be verified by weighing the FCM on a calibrated scale and confirming the mass does not exceed $500$ grams.
    \item Requirement shall be verified via MIL-STD-810H Method 500.6 for low pressure testing procedures.
    \item Requirement shall be verified via MIL-STD-810H Methods 501.7 and 502.7 for temperature testing procedures.
    \item Requirement shall be verified via MIL-STD-810H Method 507.6 for humidity testing procedures.
    \item Requirement shall be verified by mounting the FCM on a vibration table and subjecting it to vibrations up to $30$ m/s$^2$ while monitoring the onboard IMU readings and system functionality.
    \item Requirement shall be verified by reviewing the PCB design files and manufacturing documentation to confirm adherence to IPC-2221 PCB design standard.
    \item Requirement shall be verified by reviewing the bill of materials (BOM) and component datasheets to confirm all materials comply with the RoHS directive restrictions on hazardous substances.
    \item Requirement shall be verified by conducting FCC Part 15 compliance testing at an accredited test facility or by reviewing FCC certification documentation for any RF-emitting modules used in the FCM design. Testing shall confirm radiated and conducted emissions remain within specified limits.
\end{enumerate}
