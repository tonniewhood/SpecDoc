...
% \textbf{Standards and Regulations}
    \item The Preprocessor shall be verified using static analysis tools such as linters and formatters to ensure compliance with the coding standards outlined under \S3.1.5.
\end{enumerate}
...
% \textbf{Standards and Regulations}
    \item The PVA Controller shall be verified using static analysis tools such as linters and formatters to ensure compliance with the coding standards outlined under \S3.1.5.
\end{enumerate}
...
% \textbf{Standards and Regulations}
    \item The ATL Controller shall be verified using static analysis tools such as linters and formatters to ensure compliance with the coding standards outlined under \S3.1.5.
\end{enumerate}
...
% \textbf{Standards and Regulations}
    \item The Control Distributor shall be verified using static analysis tools such as linters and formatters to ensure compliance with the coding standards outlined under \S3.1.5.
\end{enumerate}
